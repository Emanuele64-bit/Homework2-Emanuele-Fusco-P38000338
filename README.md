...
Now, open another ROS 2 workspace and launch the `ros2_kdl_node` with its `param.yaml` and specify the type of the controller you want to adopt by using the `cmd_interface` argument:
```sh
